...
class Alertas(models.Model):
    ...
    def generar_alertas_automaticas():
        ...
        # Obtener todos los productos activos (no eliminados) con stock
        ...
        for producto in productos:
            ...
            # (para no crear duplicados cada día)
            ...
            if alerta_existente:
                ...
                if alerta_existente.tipo_alerta != tipo or alerta_existente.mensaje != mensaje:
